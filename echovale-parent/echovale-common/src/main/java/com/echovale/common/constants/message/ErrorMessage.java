package com.echovale.common.constants.message;
...
public class ErrorMessage {
    public static final String BadRequestMessage          = "参数错误";
    public static final String UnauthorizedMessage        = "身份验证失败";
    ...
    public static final String NotImplementedMessage      = "请求不存在";
}
